...
\begin{document}
\title{Proyecto Módulo 2\\Resolución computacional de la ecuación de Poisson utilizando el método de diferencias finitas y
visualización por medio de gnuplot}
\author{SP2118}
\date{\today}
...
\frame{\frametitle{La Ecuación de Poisson}
\begin{center}¿Quién?/Origen\end{center}
}

\frame{\frametitle{La Ecuación de Poisson}
\begin{center}EDP Elíptica\end{center}
}

\frame{\frametitle{La Ecuación de Poisson}
\begin{center}¿Para qué sirve?\end{center}
}

\section{Python+C}

\frame{\frametitle{Python+C}
\begin{center}Extensión\end{center}
}

\frame{\frametitle{Python+C}
\begin{center}Sobre el módulo en C: implementación del método en diferencias finitas\end{center}
}

\section{Método en diferencias finitas}

\frame{\frametitle{Método en diferencias finitas}
\begin{center}Métodos numéricos\end{center}
}

\frame{\frametitle{Método en diferencias finitas}
\begin{center}Uso de expansión de Taylor\end{center}
}

\frame{\frametitle{Método en diferencias finitas}
\begin{center}Equivalente a sistema de ecuaciones lineales/Gauss-Seidel\end{center}
}

\section{Uso de gnuplot}

\frame{\frametitle{Uso de gnuplot}
\begin{center}Lo básico\end{center}
}

\frame{\frametitle{Uso de gnuplot}
\begin{center}Scripting/Inserción de script en bash\end{center}
}

\frame{\frametitle{Uso de gnuplot}
\begin{center}¿Y para qué uso esto?/¿Qué otra forma de comparación con la solución analítica implemento?\end{center}
}
\section{¿Qué hay extra?}

\frame{\frametitle{¿Qué hay extra?}
\begin{center}VPython\end{center}
}

\frame{\frametitle{¿Qué hay extra?}
\begin{center}Dibujado de superficies con VPython (¿faces?)... un poco complicado... ¿Panda3D?\end{center}
}
...
\frame{\frametitle{Conclusión y ¿qué falta?}
\begin{center}¿Qué falta?/Una mejor visualización 3D (¿Panda3D?)\end{center}
}
