...
El siguiente es un algoritmo que permite solucionar el sistema de ecuaciones que se presenta (este algoritmo hace uso del método iterativo de Gauss-Seidel, por lo que permite que $\displaystyle m\neq n$):
